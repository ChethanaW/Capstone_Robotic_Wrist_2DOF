...
void loop() {
  ...
  for (int i = 0 ; i < (11*5); i= i+5){// while (Serial.available()>0) { // check if there is a value in serial buffer
//    int tmp = i;
    // grabbing inputs from serial
    input = inputarray[i];//Serial.parseInt();
    Serial.println("input1");
    Serial.println(input); //funct
  
    input2 = inputarray[i+1];//Serial.parseInt();
    Serial.println("input2");
    Serial.println(input2); //data1
  
    input3 = inputarray[i+2];//Serial.parseInt();
    Serial.println("input3");
    Serial.println(input3); //data2
  
    input4 = inputarray[i+3];//Serial.parseInt();
    Serial.println("input4");
    Serial.println(input4); //data3
  
    input5 = inputarray[i+4];//Serial.parseInt();
